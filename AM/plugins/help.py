...
from AM import app
from AM.misc import SUDOERS
from AM.utils import help_pannel
from AM.utils.database import get_lang, is_commanddelete_on
from AM.utils.decorators.language import (LanguageStart,
                                                  languageCB)
from AM.utils.inline.help import (help_back_markup,
                                          private_help_panel)
...
async def helper_private(
    ...
    if is_callback:
        ...
        await update.reply_caption("powered by Resso")
