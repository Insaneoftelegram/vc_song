...
from AM import (Apple, Resso, SoundCloud, Spotify, Telegram,
                        YouTube, app)
from AM.core.call import Anon
from AM.utils import seconds_to_min, time_to_seconds
from AM.utils.channelplay import get_channeplayCB
from AM.utils.database import is_video_allowed
from AM.utils.decorators.language import languageCB
from AM.utils.decorators.play import PlayWrapper
from AM.utils.formatters import formats
from AM.utils.inline.play import (livestream_markup,
                                          playlist_markup,
                                          slider_markup, track_markup)
from AM.utils.inline.playlist import botplaylist_markup
from AM.utils.logger import play_logs
from AM.utils.stream.stream import stream
        ...
        if await YouTube.exists(url):
            ...
            try:
                ...
                await mystic.edit_text(
                    "ᴛʜᴇʀᴇ's ᴀɴ ᴇʀʀᴏʀ ɪɴ ᴛʜᴇ ʙᴏᴛ, ᴩʟᴇᴀsᴇ ʀᴇᴩᴏʀᴛ ɪᴛ ᴛᴏ sᴜᴩᴩᴏʀᴛ ᴄʜᴀᴛ @Resso_support ."
                )
